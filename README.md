...
`importance_criteria.md` 定义了新闻重要性的判断标准，其中「按受众相关性」部分包含占位符，**需要根据自己的背景填写**，否则 AI 无法准确筛选对你有价值的新闻。
...
```
请阅读 importance_criteria.md，向我提问以了解我的背景和兴趣领域，然后帮我填写其中的占位符。
```

**方式二：直接编辑文件**

打开 `importance_criteria.md`，将以下占位符替换为你自己的描述：
